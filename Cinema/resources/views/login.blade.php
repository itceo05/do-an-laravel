                ...
                <div class="account-area">
                    ...
                    <form class="account-form" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" placeholder="Enter Your Email" id="email2" name="email" value="{{ old('email') }}">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group checkgroup">
                            ...
                            <a href="{{ route('customer.check-email') }}" class="forget-pass">Forget Password</a>
                        </div>
