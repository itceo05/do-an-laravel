            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <a href="{{route('food.create')}}" class="btn btn-gradient-primary btn-icon-text">
                                    <i class="mdi mdi-food btn-icon-prepend"></i> AddData </a>
                            </div>
                            <div class="col-md-6">
                                <div class="row">
                        ...
                        <table class="table mt-3">
                            ...
                            <tbody>
                                ...
                                <tr class="text-center">
                                    ...
                                    <td>$ {{$value->price}}</td>
                                    <td><label
                                            class="{{($value->combo == 2)? 'badge-outline-success' : 'badge-outline-danger'}} badge  badge-pill">{{($value->combo == 1)? 'No Combo' : 'Combo'}}</label>
                                    </td>
                                    <td><label
                                            class="{{($value->status == 1)? 'badge-outline-success' : 'badge-outline-danger'}} badge  badge-pill">{{($value->status == 1)? 'Stocking' : 'Out of stock'}}</label>
                                    </td>
                                    <td><a href="{{route('food.edit', $value->id)}}"
                                            class="btn btn-gradient-dark btn-sm w-75"> <i class="far fa-edit"></i></a>
                                        <form action="{{route('food.destroy', $value->id)}}" method="POST">
                                            @method('DELETE')
                                            @csrf
                        ...
                        <tr class="text-center">
                            ...
                            <td><a href="{{route('food.edit', $value->id)}}" class="btn btn-gradient-dark btn-sm w-75">
                        ...
                        <tr class="odd">
                            <td valign="top" colspan="8" class="dataTables_empty text-center ">No results found for
                                keyword <strong> " {{$keywords}} "</strong><br><a href="{{route('food.index')}}"
