                ...
                <div class="card">
                    <div class="card-body">
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-10">
                                        <form action="{{route('search-comment')}}" method="GET">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr class="text-center">
                                    ...
                                    <td><label
                                            class="{{($value->status == 1)? 'badge-outline-success' : 'badge-outline-danger'}} badge  badge-pill">{{($value->status == 1)? 'Display' : 'Not Displayed'}}</label>
                                    </td>
                                    <td><a href="{{route('edit-comment', $value->id)}}"
                                            class="btn btn-gradient-dark btn-sm w-100"> <i
                                                class="far fa-eye"></i></a>
                                        <form action="{{route('delete-comment', $value->id)}}" method="POST">
                                            <!-- @method('DELETE') -->
                                            @csrf
                        ...
                        <tr class="text-center">
                            ...
                            <td><a href="{{route('delete-comment', $value->id)}}" class="btn btn-gradient-dark btn-sm w-100">
                            <i
                                                class="far fa-eye"></i></a>
                                <form action="{{route('delete-comment', $value->id)}}" method="POST">
                                    <!-- @method('DELETE') -->
                        ...
                        @else
                        <tr class="odd">
                            <td valign="top" colspan="8" class="dataTables_empty text-center ">No results found for status <strong> " {{($keywords == 2)? 'Not Displayed' : 'Display'}} "</strong><br><a href="{{route('comment')}}"
