                ...
                <div class="row flex-grow">
                    <div class="col-lg-6 d-flex align-items-center justify-content-center">
                        <div class="auth-form-transparent text-left">
                            ...
                            <h6 class="font-weight-light">Enter email to check account!</h6>
                            <form action="{{route('post_Forgot')}}" class="pt-3" method="POST">
                                @csrf
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-prepend bg-transparent">
                                            <span class="input-group-text bg-transparent border-right-0">
                                                <i class=" mdi mdi-gmail text-primary"></i>
                                            </span>
                                        </div>
                                        <input type="text" class="form-control form-control-lg border-left-0 {{($errors->has('email'))? 'error' : ''}}" id=""
