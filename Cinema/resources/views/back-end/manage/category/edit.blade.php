    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <form action="{{route('category.update', $finbyId->id)}}" class="forms-sample" method="POST">
                            @METHOD('PUT')
                            @csrf
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control {{($errors->has('name'))? 'error' : ''}}"
                                            name="name" onkeyup="ChangeToSlug()" id="title" placeholder="Film Category"
                                            value="{{$finbyId->name}}">
                                        @if($errors->has('name'))
                                    ...
                                    <div class="form-group">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                name="slug" id="slug" placeholder="Slug" value="{{$finbyId->slug}}">
                                            @if($errors->has('slug'))
                                            <div class="alert-back mt-2" role="alert">
                                                <p><i class="mdi mdi-alert-circle"> </i><strong>Remind!</strong>
                                                    {{$errors->first('slug')}}</p>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>{{$finbyId->name}}</td>
                                    <td><label
                                            class="{{($finbyId->status == 1)? 'badge-outline-success' : 'badge-outline-danger'}} badge  badge-pill">{{($finbyId->status == 1)? 'Show' : 'Hide'}}</label>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
