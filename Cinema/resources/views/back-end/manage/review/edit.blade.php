                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="mt-4 py-2 border-top border-bottom">
                                    <ul class="nav profile-navbar">
                                        ...
                                        <li class="nav-item">
                                            <button type="button" class="btn btn-outline-success btn-fw active"
                                                id="btn-feedback">
                                ...
                                <div id="div">
                                    <div class="d-flex align-items-start profile-feed-item border-bottom py-4">
                                        ...
                                        <div class="ml-4">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <h6> {{$Auth->name}} <small class="ml-4 text-muted"><i
                                                                class="mdi mdi-clock mr-1"></i>{{$TimeReview[0]}}</small>
                                                    </h6>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="text-right btn-handle">
                                                        <form action="{{route('review.update', $finbyId->id)}}"
                                                            method="POST">
                                                            @METHOD('PUT')
                                                            @csrf
                                                            <div class="row">
                                                                <div class="col-md-7">
                                                                    <div class="form-group">
                                                                        <select class="form-control form-control-sm"
                                                                            ...
                                                                            name="status">
                                                                            <option value="2" {{($finbyId->status == 2)? 'selected' : ''}}>Not Displayed</option>
                                                                            <option value="1" {{($finbyId->status == 1)? 'selected' : ''}}>Display</option>
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                                <div class="com-md-4">
                                                                    <button type="submit"
                                                                        class="btn btn-gradient-primary btn-md">Submit</button>
                                                                </div>
                                                            </div>
                                                        </form>
                                                    </div>
                                            ...
                                            <p class=""> {{$finbyId->content}}</p>
                                            <p class="small text-muted mt-2 mb-0">
                                                <span class="ml-2">
                                                    <i class="mdi mdi-television-guide mr-1"></i> {{$finbyId->name}}
                                                </span>
                                                </span>
                                            </p>
                                        </div>
