                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr class="text-center">
                                    ...
                                    <td><a href="{{route('review.edit', $value->id)}}"
                                            class="btn btn-gradient-dark btn-sm w-100"> <i class="far fa-eye"></i></a>
                        ...
                        <tr class="text-center">
                            ...
                            <td><a href="{{route('review.edit', $value->id)}}"
                                    class="btn btn-gradient-dark btn-sm w-100">
                        ...
                        <tr class="odd">
                            <td valign="top" colspan="8" class="dataTables_empty text-center ">No results found for
                                status <strong> " {{($keywords == 2)? 'Not Displayed' : 'Display'}} "</strong><br><a
                                    href="{{route('review.index')}}" class="btn btn-outline-primary mt-3">Back!</a></td>
                        </tr>
                        </tbody>
                        </table>
                        @endif
