        ...
        <div class="content-wrapper">
            <div class="row">
                <div class="col-md-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('blog.update', $finbyId->id) }}" class="forms-sample" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control {{ $errors->has('content') ? 'error' : '' }}"
                                        ...
                                        placeholder="Enter Content">{{ $finbyId->content }}</textarea>
                                        ...
                                        <div class="form-check">
                                            <label class="form-check-label">
                                                <input type="radio" class="form-check-input" name="status"
                                                    ...
                                                    {{ $finbyId->status == 1 ? 'checked' : '' }}> Show <i
                                        ...
                                        <div class="form-check">
                                            <label class="form-check-label">
                                                <input type="radio" class="form-check-input" name="status"
                                                    ...
                                                    {{ $finbyId->status == 2 ? 'checked' : '' }}> Hide <i
                                                    class="input-helper"></i></label>
                                        </div>
                                    </div>
                                </div>
